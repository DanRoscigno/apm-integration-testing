...
async function run() {
  const browser = await puppeteer.launch({
    args: ['--disable-dev-shm-usage', '--remote-debugging-port=9222', '--no-sandbox', '--disable-setuid-sandbox'] // see https://github.com/puppeteer/puppeteer/blob/master/docs/troubles
hooting.md#tips
  })
